...
interface FunctionParameter {
    name: string; // e.g., <summand_1> - Not used in this simplified version yet
    type: string; // e.g., "Integer", "String", "Any", "Integer | Float | mixed"
    required: boolean;
}

interface FunctionInfo {
    name: string;
    paramTypes: string[]; // Array of expected type strings for each parameter position
    minArgs: number;
    maxArgs: number;
    returnType: string; // e.g., "Integer | Float", "String", "Boolean", "Any", "Object"
    description: string;
}

// Define custom types for clarity where standard types are insufficient
type NumberLike = "Integer" | "Float" | "Number"; // For functions accepting integers, floats, or mixed
type TimestampString = "String"; // String representing a timestamp
type UriString = "String"; // String representing a URI
type DataUriString = "String"; // String representing a Data URI
type Base64String = "String"; // String representing base64 encoded data
type BinaryString = "String"; // String representing binary data (often base64 internally)
type TimespanString = "String"; // String representing a timespan
type XmlString = "String"; // String containing XML
type JsonString = "String"; // String containing JSON
type XmlObject = "Object"; // Represents an XML object/node structure
type Collection = "String" | "Array" | "Object"; // General collection type

// --- Complete Function Data Map ---
export const workflowFunctions = new Map<string, FunctionInfo>([
  // A
  [
    "action",
    {
      ...
      returnType: "Object",
      description:
        "Return the current action's output object at runtime. Use properties like .outputs, .inputs, .startTime, .endTime, .status, etc. (special context).",
    },
  ],
  [
    "actions",
    {
      ...
      returnType: "Object",
      description:
        "Return a specific action's output object at runtime, including outputs, inputs, status, etc.",
    },
  ],
  [
    "add",
  ...
  [
    "addproperty",
    {
      ...
      returnType: "Object",
      description:
        "Add a property and its value to a JSON object. Fails if property already exists.",
    },
  ],
  [
    "addseconds",
  ...
  [
    "base64tostring",
    {
      ...
      returnType: "String",
      description:
        "Return the string version for a base64-encoded string (decoding). Preferred over decodeBase64().",
    },
  ],
  [
    "binary",
  ...
  [
    "body",
    {
      ...
      returnType: "Any",
      description:
        "Return an action's body output. Shorthand for actions('<actionName>').outputs.body.",
    },
  ],
  [
    "bool",
  ...
  [
    "contains",
    {
      ...
      returnType: "Boolean",
      description:
        "Check whether a collection has a specific item. Case-sensitive.",
    },
  ],
  [
    "convertfromutc",
  ...
  [
    "datauritobinary",
    {
      ...
      returnType: "BinaryString",
      description:
        "Return the binary version for a data uniform resource identifier (URI). Preferred over decodeDataUri().",
    },
  ],
  [
    "datauritostring",
  ...
  [
    "decodebase64",
    {
      ...
      returnType: "String",
      description:
        "Return the string version for a base64-encoded string. Deprecated, use base64ToString().",
    },
  ],
  [
    "decodedatauri",
    {
      ...
      returnType: "BinaryString",
      description:
        "Return the binary version for a data uniform resource identifier (URI). Not preferred, use dataUriToBinary().",
    },
  ],
  [
    "decodeuricomponent",
  ...
  [
    "encodeuricomponent",
    {
      ...
      description:
        "Return a URI-encoded version for a string by replacing URL-unsafe characters with escape characters. Not preferred, use uriComponent().",
    },
  ],
  [
    "empty",
  ...
  [
    "endswith",
    {
      ...
      returnType: "Boolean",
      description:
        "Check whether a string ends with a specific substring. Not case-sensitive.",
    },
  ],
  [
    "equals",
  ...
  [
    "formdatamultivalues",
    {
      ...
      returnType: "Array",
      description:
        "Create an array with the values that match a key name in an action's form-data or form-encoded outputs.",
    },
  ],
  [
    "formdatavalue",
    {
      ...
      returnType: "String",
      description:
        "Return a single value that matches a key name in an action's form-data or form-encoded output. Throws error if multiple matches.",
    },
  ],
  [
    "formatnumber",
  ...
  [
    "indexof",
    {
      ...
      returnType: "Integer",
      description:
        "Return the starting position or index value for a substring. Not case-sensitive. Returns -1 if not found.",
    },
  ],
  [
    "int",
  ...
  [
    "item",
    {
      ...
      returnType: "Any",
      description:
        "Return the current item in an array during a repeating action's current iteration (e.g., inside ForEach applied to array). (special context).",
    },
  ],
  [
    "items",
    {
      ...
      returnType: "Any",
      description:
        "Return the current item from a specific ForEach or Until loop's current cycle. (special context).",
    },
  ],
  [
    "iterationindexes",
    {
      ...
      returnType: "Integer",
      description:
        "Return the index value for the current iteration inside an Until loop. (special context).",
    },
  ],
  ...
  [
    "lastindexof",
    {
      ...
      returnType: "Integer",
      description:
        "Return the starting position or index value for the last occurrence of a substring. Not case-sensitive.",
    },
  ],
  [
    "length",
  ...
  [
    "listcallbackurl",
    {
      ...
      returnType: "String",
      description:
        "Return the 'callback URL' that calls a trigger or action. Works only with specific connector types (HttpWebhook, ApiConnectionWebhook). (special context).",
    },
  ],
  ...
  [
    "nthindexof",
    {
      ...
      returnType: "Integer",
      description:
        "Return the starting position or index value where the nth occurrence of a substring appears in a string. Returns -1 if not found.",
    },
  ],
  ...
  [
    "rand",
    {
      ...
      returnType: "Integer",
      description:
        "Return a random integer from a specified range, inclusive of minValue, exclusive of maxValue.",
    },
  ],
  [
    "range",
  ...
  [
    "replace",
    {
      ...
      returnType: "String",
      description:
        "Replace a substring with the specified string, and return the result string. Case-sensitive.",
    },
  ],
  [
    "result",
    {
      ...
      description:
        "Return the results (inputs and outputs) from the top-level actions inside the specified scoped action (For_each, Until, Scope).",
    },
  ],
  [
    "reverse",
  ...
  [
    "setproperty",
    {
      ...
      returnType: "Object",
      description:
        "Set the value for a JSON object's property and return the updated object. Adds property if it doesn't exist.",
    },
  ],
  [
    "skip",
  ...
  [
    "slice",
    {
      ...
      returnType: "String",
      description:
        "Return a substring by specifying the starting and ending position or value. Character at endIndex is not included.",
    },
  ],
  [
    "sort",
  ...
  [
    "startswith",
    {
      ...
      returnType: "Boolean",
      description:
        "Check whether a string starts with a specific substring. Not case-sensitive.",
    },
  ],
  [
    "string",
  ...
  [
    "substring",
    {
      ...
      returnType: "String",
      description:
        "Return characters from a string, starting from the specified position (index), for the specified length.",
    },
  ],
  [
    "subtractfromtime",
  ...
  [
    "ticks",
    {
      ...
      description:
        "Return the number of ticks (100-nanosecond intervals) for a specified timestamp.",
    },
  ],
  [
    "tolower",
  ...
  [
    "triggerbody",
    {
      ...
      returnType: "Any",
      description:
        "Return the trigger's body output at runtime. Shorthand for trigger().outputs.body.",
    },
  ],
  [
    "triggerformdatamultivalues",
    {
      ...
      returnType: "Array",
      description:
        "Create an array with values that match a key name in a trigger's form-data or form-encoded output.",
    },
  ],
  [
    "triggerformdatavalue",
    {
      ...
      returnType: "String",
      description:
        "Return a string with a single value that matches a key name in a trigger's form-data or form-encoded output. Throws error if multiple matches.",
    },
  ],
  [
  ...
  [
    "triggeroutputs",
    {
      ...
      returnType: "Object", // Contains the outputs object
      description:
        "Return the trigger's output object at runtime. Shorthand for trigger().outputs.",
    },
  ],
  [
    "trim",
  ...
  [
    "union",
    {
      ...
      returnType: "Array | Object",
      description:
        "Return a collection that has all the items from the specified collections. No duplicates.",
    },
  ],
  [
    "uricomponent",
    {
      ...
      returnType: "UriString",
      description:
        "Return a URI-encoded version for a string by replacing URL-unsafe characters with escape characters. Preferred over encodeUriComponent().",
    },
  ],
  [
  ...
  [
    "uricomponenttostring",
    {
      ...
      returnType: "String",
      description:
        "Return the string version for a uniform resource identifier (URI) encoded string (decoding).",
    },
  ],
  [
    "urihost",
  ...
  [
    "workflow",
    {
      ...
      returnType: "Object",
      description:
        "Return details about the workflow itself during run time, including id, name, type, location, run, and tags.",
    },
  ],
